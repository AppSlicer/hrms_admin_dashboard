...
export default function TableRowCol(props: Props) {
    ...
    return (
        <div 
            className={`flex-1 h-full flex justify-center items-center text-black dark:text-gray-300 border-[#A7A7A7] dark:border-gray-800 border-r last:border-r-0 px-2 overflow-hidden ${props.className || ""}`}
            style={props.style}
        >
            {isString ? (
